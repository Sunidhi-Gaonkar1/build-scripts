...
wget https://raw.githubusercontent.com/Sunidhi-Gaonkar1/build-scripts/refs/heads/torch_test/t/torchvision/0001-Exclude-source-that-has-commercial-license.patch
